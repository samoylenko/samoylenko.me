...
. https://en.wikipedia.org/wiki/Confirmation_bias[*Making decisions in isolation*] - in the world of instant communication and the Internet, assuming that you are the first to face this problem and that no one else hasn't solved it.
